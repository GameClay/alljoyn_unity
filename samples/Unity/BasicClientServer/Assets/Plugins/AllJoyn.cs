...
namespace AllJoynUnity
{
	public partial class AllJoyn
	{
		...
		public const string DLL_IMPORT_TARGET = "alljoyn_unity";
...
#if UNITY_ANDROID
		public static int UnityInitialize(string libMonoPath = "")
		{
			return (QStatus)alljoyn_unity_initialize(libMonoPath);
		}

		public static void UnityDestroy()
		{
			alljoyn_unity_destroy();
		}
#endif
...
#if UNITY_ANDROID
		[DllImport(DLL_IMPORT_TARGET)]
		private extern static int alljoyn_unity_initialize(
			[MarshalAs(UnmanagedType.LPStr)] string libMonoPath);

		[DllImport(DLL_IMPORT_TARGET)]
		private extern static void alljoyn_unity_destroy();
#endif
		#endregion
	}
}
